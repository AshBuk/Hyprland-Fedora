...
# -fpermissive is a C++ only flag, do NOT use it with CMAKE_C_FLAGS
GCC15_CXX_FLAGS="-fpermissive"
...
cmake -B build -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="$VENDOR_PREFIX" \
  ...
  -DCMAKE_CXX_FLAGS="$GCC15_CXX_FLAGS" \
...
# 8) Hyprland (needs GCC15 compat flags for generated protocol code)
cmake -B build \
